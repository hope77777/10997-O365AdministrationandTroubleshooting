...
6. Open an InPrivate window, go to **https\://adatum*yyxxxxx*.sharepoint.com/sites/marketing**, and then sign in as  **Ada@Customdomainname.hostdomain.com** with Ada's password, where ***Customdomainname.hostdomain.com*** is your unique domain name.
