...
4. Review the other available options, and then click  **Close**.

5. In Microsoft 365 admin center, on Services & add-ins page, click  **User owned apps and services**.

6. Verify that both options are selected. If not, select both options.

7. Click  **Save changes**, and then close the pane.
