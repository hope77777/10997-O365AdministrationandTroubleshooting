...
5. Sign out, and then sign in as Abbi Skinner by using the username  **Abbi\@Customdomainname.hostdomain.com** and Abbi's password.

6. Access Abbi's Office 365 settings and verify that she does not have the option to install the Office 365 apps.

7. Sign out as Abbi Skinner, and then sign in as  **Beth** by using the username **Beth\@Customdomainname.hostdomain.com** and Beth's password.
